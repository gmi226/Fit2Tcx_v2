...
public class LapMesg extends Mesg implements MesgWithEvent {
   ...
   static {
      ...
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_START_TIME, StartTimeFieldNum, 134, 1, 0, "", false, Profile.Type.DATE_TIME));
      field_index++;
      ...
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_TOTAL_TIME, TotalTimerTimeFieldNum, 134, 1000, 0, "s", false, Profile.Type.UINT32));
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_DISTANCE, TotalDistanceFieldNum, 134, 100, 0, "m", false, Profile.Type.UINT32));
      field_index++;
      ...
      subfield_index++;
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_CALORIES, TotalCaloriesFieldNum, 132, 1, 0, "kcal", false, Profile.Type.UINT16));
      field_index++;
      ...
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_MAX_SPEED, MaxSpeedFieldNum, 132, 1000, 0, "m/s", false, Profile.Type.UINT16));
      lapMesg.fields.get(field_index).components.add(new FieldComponent(111, false, 16, 1000, 0)); // enhanced_max_speed
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_AVG_HEART, AvgHeartRateFieldNum, 2, 1, 0, "bpm", false, Profile.Type.UINT8));
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_MAX_HEART, MaxHeartRateFieldNum, 2, 1, 0, "bpm", false, Profile.Type.UINT8));
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_CADENCE, AvgCadenceFieldNum, 2, 1, 0, "rpm", false, Profile.Type.UINT8));
      subfield_index = 0;
      ...
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_INTENSITY, IntensityFieldNum, 0, 1, 0, "", false, Profile.Type.INTENSITY));
      field_index++;
      lapMesg.addField(new Field(Fit.TAG_LAP_TRIGGER, LapTriggerFieldNum, 0, 1, 0, "", false, Profile.Type.LAP_TRIGGER));
      field_index++;
