...
public class RecordMesg extends Mesg {
   ...
   static {int field_index = 0;
      ...
      recordMesg.addField(new Field(Fit.TAG_RECORD_TIME_STAMP, TimestampFieldNum, 134, 1, 0, "s", false, Profile.Type.DATE_TIME));
      field_index++;
      recordMesg.addField(new Field(Fit.TAG_LATITUDE, PositionLatFieldNum, 133, 1, 0, "semicircles", false, Profile.Type.SINT32));
      field_index++;
      recordMesg.addField(new Field(Fit.TAG_LONGITUDE, PositionLongFieldNum, 133, 1, 0, "semicircles", false, Profile.Type.SINT32));
      field_index++;
      recordMesg.addField(new Field(Fit.TAG_ALTITUDE, AltitudeFieldNum, 132, 5, 500, "m", false, Profile.Type.UINT16));
      recordMesg.fields.get(field_index).components.add(new FieldComponent(78, false, 16, 5, 500)); // enhanced_altitude
      field_index++;
      recordMesg.addField(new Field(Fit.TAG_RECORD_HEART, HeartRateFieldNum, 2, 1, 0, "bpm", false, Profile.Type.UINT8));
      field_index++;
      recordMesg.addField(new Field(Fit.TAG_CADENCE, CadenceFieldNum, 2, 1, 0, "rpm", false, Profile.Type.UINT8));
      field_index++;
      recordMesg.addField(new Field(Fit.TAG_DISTANCE, DistanceFieldNum, 134, 100, 0, "m", true, Profile.Type.UINT32));
      field_index++;
      recordMesg.addField(new Field(Fit.TAG_RECORD_SPEED, SpeedFieldNum, 132, 1000, 0, "m/s", false, Profile.Type.UINT16));
