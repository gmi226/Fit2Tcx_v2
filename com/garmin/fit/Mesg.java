...
public class Mesg {
    ...
    public String getTimeStampNew() {
        ...
        return sdf.format(timestampToDateTime(getFieldLongValue(253, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD)).getDate());
    }

    public String getDegrees(Object value) {

        return String.valueOf(((Integer) value * ( 180 / Math.pow(2, 31))));
    }
}
