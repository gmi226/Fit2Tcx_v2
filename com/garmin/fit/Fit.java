...
public class Fit {
   ...
   public final static String TAG_XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\" ?>";
   public final static String TAG_TRAINING_CENTER = "TrainingCenterDatabase";
   public final static String TAG_TRAINING_CENTER_XMLNS = "  xmlns=\"http://www.garmin.com/xmlschemas/TrainingCenterDatabase/v2\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.garmin.com/xmlschemas/ActivityExtension/v2 http://www.garmin.com/xmlschemas/ActivityExtensionv2.xsd http://www.garmin.com/xmlschemas/FatCalories/v1 http://www.garmin.com/xmlschemas/fatcalorieextensionv1.xsd http://www.garmin.com/xmlschemas/TrainingCenterDatabase/v2 http://www.garmin.com/xmlschemas/TrainingCenterDatabasev2.xsd\"";
   public final static String TAG_ACTIVITIES = "Activities";
   public final static String TAG_ACTIVITY = "Activity";
   public final static String TAG_ID = "Id";
   public final static String TAG_SPORT = "Sport";
   public final static String TAG_VALUE = "Value";
   public final static String TAG_POSITION = "Position";
   public final static String TAG_LATITUDE = "LatitudeDegrees";
   public final static String TAG_LONGITUDE = "LongitudeDegrees";
   public final static String TAG_TRACK = "Track";
   public final static String TAG_TRACK_POINT = "Trackpoint";
   public final static String TAG_EXTENSIONS = "Extensions";
   public final static String TAG_TPX = "TPX";
   public final static String TAG_TPX_XMLNS = " xmlns=\"http://www.garmin.com/xmlschemas/ActivityExtension/v2\"";
   public final static String TAG_DISTANCE = "DistanceMeters";
   public final static String TAG_ALTITUDE = "AltitudeMeters";
   public final static String TAG_CADENCE = "Cadence";

   public final static String TAG_RECORD_HEART = "HeartRateBpm";
   public final static String TAG_RECORD_TIME_STAMP = "Time";

   public final static String TAG_RECORD_SPEED = "Speed";

   public final static String TAG_LAP = "Lap";
   public final static String TAG_LAP_INTENSITY = "Intensity";
   public final static String TAG_LAP_START_TIME = "StartTime";
   public final static String TAG_LAP_TOTAL_TIME = "TotalTimeSeconds";
   public final static String TAG_LAP_MAX_SPEED = "MaximumSpeed";
   public final static String TAG_LAP_CALORIES = "Calories";
   public final static String TAG_LAP_AVG_HEART = "AverageHeartRateBpm";
   public final static String TAG_LAP_MAX_HEART = "MaximumHeartRateBpm";
   public final static String TAG_LAP_TRIGGER = "TriggerMethod";

   public final static String TAG_CREATOR = "Creator";
   public final static String TAG_CREATOR_HEADER = " xsi:type=\"Device_t\"";
   public final static String TAG_CREATOR_NAME = "Name";
   public final static String TAG_CREATOR_UNIT_ID = "UnitId";
   public final static String TAG_CREATOR_PRODUCT_ID = "ProductID";
   public final static String TAG_CREATOR_VERSION = "Version";
   public final static String TAG_CREATOR_VERSION_MAJOR = "VersionMajor";
   public final static String TAG_CREATOR_VERSION_MINOR = "VersionMinor";
